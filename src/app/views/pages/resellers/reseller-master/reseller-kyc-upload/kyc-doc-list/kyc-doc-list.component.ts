...
const ALLOWED_EXTENSIONS = ["pdf", "PDF", "png", "PNG", "jpg", "JPG", "jpeg", "JPEG"];
...
export class KycDocListComponent implements OnInit {
  ...
  prepareFilesList(files: Array<any>) {
    ...
    for (const item of files) {
      ...
      if (!ALLOWED_EXTENSIONS.includes(fileProp[1])) {
        extError = true;
  ...
  viewFile(i: number) {
    this.resellerService.kycFileViewEvent({
      outIndex: this.outIndex,
      innerIndex: this.innerIndex,
      type: this.type,
      fileIndex: i
